...
ActiveRecord::Schema.define(:version => 20130316114848) do
  ...
  create_table "categories_manuals", :id => false, :force => true do |t|
    t.integer "category_id"
    t.integer "manual_id"
  end

  add_index "categories_manuals", ["category_id", "manual_id"], :name => "index_categories_manuals_on_category_id_and_manual_id"
  ...
  create_table "steps_manuals", :id => false, :force => true do |t|
    t.integer "step_id"
    t.integer "manual_id"
  end

  add_index "steps_manuals", ["step_id", "manual_id"], :name => "index_steps_manuals_on_step_id_and_manual_id"
