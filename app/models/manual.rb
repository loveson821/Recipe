class Manual < ActiveRecord::Base
  attr_accessible :body, :publish_date, :title, :category_ids, :step_ids, :steps_attributes, :spree_products, :cookTime, :quantity, :kcal, :difficulty, :image, :materials_attributes
